...
class Product(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    reference_code: Mapped[str | None] = mapped_column(String(40), unique=True, nullable=True)
    product_type: Mapped[str] = mapped_column(String(40), default="extrait", nullable=False)
...
class Inventory(Base):
    """Legacy aggregate retained for cart compatibility during Sprint 4."""
